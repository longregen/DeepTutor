...
from src.services.config.loader import get_embedding_config, get_llm_config
...
async def rag_search(
    ...
    **kwargs,
    ...
    if kb_base_dir is None:
        try:
            from src.services.config.loader import get_path_from_config, load_config_with_main
