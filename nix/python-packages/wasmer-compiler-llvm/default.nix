# Build wasmer-compiler-llvm from scratch with __rust_probestack fix
...
STUB_EOF
  ...
  pythonImportsCheck = [ "wasmer_compiler_llvm" ];

  meta = {
    description = "Python extension to run WebAssembly binaries (LLVM compiler)";
