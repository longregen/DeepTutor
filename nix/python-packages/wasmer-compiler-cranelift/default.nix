# Build wasmer-compiler-cranelift from scratch with __rust_probestack fix
...
STUB_EOF
  ...
  pythonImportsCheck = [ "wasmer_compiler_cranelift" ];

  meta = {
    description = "Python extension to run WebAssembly binaries (Cranelift compiler)";
