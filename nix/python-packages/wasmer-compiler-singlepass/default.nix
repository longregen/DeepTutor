# Build wasmer-compiler-singlepass from scratch with __rust_probestack fix
...
STUB_EOF
  ...
  pythonImportsCheck = [ "wasmer_compiler_singlepass" ];

  meta = {
    description = "Python extension to run WebAssembly binaries (Singlepass compiler)";
