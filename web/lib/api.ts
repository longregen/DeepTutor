...
// - Empty string "" means same-origin (API at /api on same domain)
// - Full URL like "http://localhost:8001" for cross-origin development
// - Set via NEXT_PUBLIC_API_BASE at build time
